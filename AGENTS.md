...
No `custom_components/` code exists yet, by design. The design is finished and lives in
[`docs/`](docs/) (`01` to `05`). Read `docs/01-data-sources.md` before touching anything that
talks to the data source, and `docs/04-architecture.md` §11 for the fourteen architectural
decisions and why each alternative was rejected.
